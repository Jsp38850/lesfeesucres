<body>
    ...
    <header>
        ...
        <h1 class="font_italic titleprincipal">Nos boissons</h1>
        ...
        <nav class="filtermenu">
            ...
            <ul>
                <li><a href="#section1" onclick='window.location.reload(false)'>Chocolats chaud</a></li>
        ...
        <div class="filtre">
            <a href="#section1">Chocolats chaud</a>
            <a href="#section2">Milkshakes</a>
            <a href="#section3">Sirop</a>
            <a href="#section4">Cocktails</a>
            <a href="#section6">Cocktails enfant</a>
            <a href="#section7">Mocktails</a>
            <a href="#section8">Cafés</a>
            <a href="#section9">Thés</a>
        </div>
        ...
        <div class="colun1">
            ...
            <div class="liste">
                <ul>
                    ...
                    <li>Cacao version neige: chocolat blanc et sucre glace</li>
                    <li>Cacao version originale: praliné, guimauve</li>
                </ul>
            </div>
    ...
    <section id="section2" class="blockwhite">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Milkshakes</u></h1>

            <div class="liste">
                <ul>
                    <li>Milkshakes: fraise</li>
                    <li>Milkshakes: banane </li>
                    <li>Milkshakes: chocolat </li>
                    <li>Milkshakes: caramel </li>
                </ul>
            </div>
    ...
    <section id="section6" class="blockwhite">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos cocktails enfants</u></h1>

            <div class="liste">
                <ul>
                    <li>Princesse: guimauve, fraise, réglisse</li>
                    <li>Licorne: guimauve, framboise</li>
                    <li>Monstre: guimauve, pêche, framboise, orange</li>
                    <li>Grenouille: guimauve, pomme</li>
    ...
    <section id="section7" class="blockgrey">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Mocktails</u></h1>

            <div class="liste2">
                <ul>
                    <li>Délice violette: fleur d'hibiscus, violette, citron, myrtille</li>
                    <li>Passion Hibiscus: fleur d'hibiscus, mangue, citron</li>
                    <li>Rose divine: pétale de rose, framboise</li>
                </ul>
            </div>
