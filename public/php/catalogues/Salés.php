<body>
    <header>
        <h1 class="font_italic titleprincipal">Nos produits Salés</h1>
    ...
    <!-- Section 1 Nos Risottos en bocaux -->
    <section id="section1" class="blockgrey">

        <div class="colun1">

            <h1><u>Nos Risottos en bocaux</u></h1>

            <div class="liste2">
                <ul>
                    <li>Risotto Forestier: riz arborio, cèpes, oignons, ails et persils</li>
                    <li>Risotto Truffe: riz arborio, riz noir, encres de seiches</li>
                    <li>Risotto Morille: riz arborio</li>
                    <li>Risotto Homard: riz arborio, riz noir </li>
                    <li>Risotto Foie gras, figues: riz arborio, petits pois, poireaux, oignons</li>
                    <li>Risotto Saumon courgette: riz arborio, oignons, thyms</li>
                    <li>Risotto Méditerranéen: riz, tomates, courgettes, aubergines, olives noires</li>
                    <li>Risotto butternut, carottes</li>
    ...
    <section id="section2" class="blockwhite">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Risottos en sachets</u></h1>

            <div class="liste2">
                <ul>
                    <li>Risotto asperge: riz arborio, carottes, asperges, oignons, ails, persils</li>
                    <li>Risotto cèpes; riz arborio, cèpes, oignons, ails</li>
                    <li>Risotto épicé: riz arborio, tomates, poivrons, oignons, ails, piments</li>
                    <li>Risotto Forestier: riz arborio, tomates, carottes, champignons, oignons, ails et persils</li>
                    <li>Risotto indien: riz, curry, carottes, raisins sec, pruneaux, abricots</li>
    ...
    <section id="section3" class="blockgrey">
        ...
        <div class="colun1">
            ...
            <div class="liste">
                <ul>
                    <li>Paëlla aux légumes et épices</li>
                    <li>Riz cantonnais: riz long, carottes, petits pois, maïs, ails</li>
                    <li>Riz mexicain: riz long, tomates, poivrons, épices, oignons, ails</li>
                    <li>Riz réunionnais: riz basmati, ananas, carottes, courgettes, petits pois, maïs</li>
                    <li>Riz de camargue: citrons, pétales de soucis, cranberries, aneths</li>
                    <li>Riz de camargue aux algues et bleuets</li>
                    <li>Riz long baies de goji, graines de lins, pétales de roses et basilics</li>
                </ul>
            </div>
    ...
    <section id="section4" class="blockwhite">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Soupes</u></h1>

            <div class="liste">
                <ul>
                    <li>Soupe Minestrone: riz, haricots blancs, petits pois, carottes, courgettes,...</li>
                    <li>Soupe Asiatique: vermicelles, champignons noirs, carottes, ...</li>
                    <li>Soupe Paysanne : choux vert , pommes de terres, carottes, poireaux, oignons</li>
                    <li>Soupe 2 lentilles : lentilles vertes et corail , pois, tomates, oignons, ails ,curry</li>
                    <li>Soupe Détox/Primeur : pommes de terres, carottes, poireaux, oignons</li>
                </ul>
            ...
            <img src="../../../public/img/produits/5Salés/3Soupe/soupe.jpg" alt="test" class="imgcolun2">
    ...
    <h1><u>Nos Madeleines, Cookies & Fougasse </u></h1>
        ...
        <ul>
            <li>Nos Cookies</li>
            <ul>
                <li>Cookies de Bénédicte : tomates pesto courgettes</li>
            </ul>   
        </ul>
        ...
        <ul>
            <li>Nos Fougasses</li>
            <ul>
                <li>Fougasse: Tomates, Herbes de Provence</li>
            </ul>   
        </ul>
...
<img src="../../../public/img/produits/5Salés/13fougasses/fougasses.jpg" alt="test" class="imgcolun2">
        ...
        <div class="colun1">
            ...
            <div class="liste">
                <ul>
                    ...
                    <li>Pennes rouges et noires : piments et encres de seiches</li>
                    <li>Pâtes papillon rose: betteraves</li>
                </ul>
    ...
    <section id="section7" class="blockgrey">
        ...
        <div class="colun1">
            ...
            <img src="../../../public/img/produits/5Salés/5Sauces/sauce et herbe.jpg" alt="test" class="imgcolun" >
    ...
    <section id="section8" class="blockwhite">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Terrines</u></h1>

            <div class="liste2">
                <ul>
                    <li>Terrine forestière aux cèpes</li>
                    <li>Terrine de campagne au piment d 'Espelette</li>
                    <li>Terrine de canard, foie gras, pain d 'épices</li>
                    <li>Terrine d'oie aux figues</li>
                    <li>Terrine de magret de canard fumé</li>
        ...
        <img src="../../../public/img/produits/5Salés/8Terrines/terrine.jpg" alt="test" class="imgcolun2">
    ...
    <section id="section9" class="blockgrey">
        ...
        <div class="colun1">
            ...
            <img src="../../../public/img/produits/5Salés/6Cake/cake salé.jpg" alt="test"  class="imgcolun">
    ...
    <section id="section11" class="blockgrey">
        ...
        <div class="colun1">
            ...
            <h1><u>Nos Tartinables</u></h1>

            <div class="liste2">
                <ul>
                    <li> Crevettes roses au curry vert & citron</li>
                    <li> Caviar d'aubergines au jus de citron "Piment d’Espelette"</li>
                    <li> Houmous poivrons et ricotta “Sel de Guérande”</li>
                    <li> Poivrons confits miel & Piment Chipotle</li>
                    <li> Tomate & cajou façon pesto</li>
                ...
                <ul>
                    <li>Terrine homard à la fleur de Sel de Guérande</li>
                    <li>Thons aux olives et citrons confits</li>
                    <li>Piperadou au chorizo doux “ Piment d’Espelette”</li>
                    <li>Langoustine au foie gras “Sel de Guérande”</li>
                    <li>Saumon & cabillaud façon tartare ”Sel de Guérande”</li>
    ...
    <section id="section12" class="blockwhite">
        ...
        <img src="../../../public/img/produits/5Salés/7Mug_cake/mugs cake salés.jpg" alt="test" class="imgcolun2">
 ...
 <section id="section13" class="blockgrey">
    ...
    <div class="colun1">
        ...
        <h1><u>Nos Galettes de pomme de terre</u></h1>
