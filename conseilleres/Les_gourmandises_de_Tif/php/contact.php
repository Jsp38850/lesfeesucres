...
else
{
	...
	else
	{
		...
		echo '<p>'.$message_formulaire_invalide.' <a href="https://www.les-fees-sucrees.fr/conseill%C3%A8res/Les_gourmandises_de_Tif/Accueil.html">Retour au formulaire</a></p>'."\n";
	};
