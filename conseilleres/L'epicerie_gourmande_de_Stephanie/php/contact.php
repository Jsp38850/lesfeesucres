...
$destinataire = 'Lepiceriegourmande.stephanie@gmail.com';
  ...
  $numero = (isset($_POST['numero'])) ? Rec($_POST['numero']) : '';
	...
	if (($nom != '') && ($email != '') && ($objet != '') && ($message != ''))
	{
		...
		$message = '<p style="font-size: 20px;"><u>Nom, prénom:</u></p><br/>' . $nom . 
					...
					'<br/><br/><p style="font-size: 20px;"><u>Numero de telephone:</u></p><br/> '. $numero .
					'<br/><br/><p style="font-size: 20px;"><u>Message:</u></p><br/> '. $message . 
					'<br/> <br/><p style="font-size: 20px;" ><u>Comment avez vous connu "L’épicerie gourmande de Stéphanie" ?</u></p>'. $choix ;
		...
		{
			echo '<p>'.$message_non_envoye.'<a href="../Accueil.html">Retour a la page Accueil</a></p>'."\n";;
	...
	else
	{
		...
		echo '<p>'.$message_formulaire_invalide.' <a href="../Accueil.html">Retour au formulaire</a></p>'."\n";
	};
